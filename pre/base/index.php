                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <?php if (UserAuth::isAuthenticated()): ?>
                                <a class="dropdown-item" href="/user/info"><i class="fa fa-fw fa-info padded-fa"></i> Info</a>
                                <?php if (UserAuth::hasCertificate()): ?>
                                        <a class="dropdown-item disabled fg-opacity-33"><i class="fa fa-fw fa-door-open padded-fa"></i>Sign out</a>
                                <?php else: ?>
                                    <a class="dropdown-item" href="/user/signout"><i class="fa fa-fw fa-door-open padded-fa"></i>Sign out</a>
                                <?php endif; ?>
                            <?php else: ?>
                                <a class="dropdown-item" href="/user/signin"><i class="fa fa-fw fa-key padded-fa"></i>Sign in</a>
                            <?php endif; ?>
                        </div>
                    </li>
